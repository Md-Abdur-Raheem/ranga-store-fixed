...
const showProductDetails = (id) => {
  ...
  <p>${specificProduct[0].description}</p>
  <h3>Price: $ ${specificProduct[0].price}</h3>
  <button onclick="addToCart(${specificProduct[0].id},${specificProduct[0].price})" id="addToCart-btn" class="buy-now btn ">Add to cart</button>
  `;
